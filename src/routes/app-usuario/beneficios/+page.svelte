    ...
    {#if activeTab === 'promociones'}
        ...
        <div class="flex gap-4 overflow-x-auto pb-4 snap-x snap-mandatory -mx-5 px-5 no-scrollbar">
          ...
          <div class="snap-center shrink-0 w-[260px] bg-white rounded-[20px] overflow-hidden border border-gray-100 shadow-[0_2px_12px_-4px_rgba(0,0,0,0.1)]">
            ...
            <div class="p-4 pt-3">
              ...
              <h3 class="font-semibold text-[16px] text-gray-900 leading-tight mb-1">
                Celular Nubia air 256GB ZTE
              </h3>
      ...
      <section>
        ...
        <div class="bg-[#faeff3] rounded-[28px] p-5 flex items-center justify-between relative overflow-hidden shadow-sm">
          <div class="z-10 w-[70%]">
            <div class="inline-block bg-[#69f0ae] text-[#004d40] text-[12px] font-extrabold px-3 py-1 rounded-full mb-3 shadow-sm">
              Nuevo
            </div>
            <h3 class="text-[16px] font-bold text-gray-900 leading-snug mb-1">
              ¡Introduce tus códigos aquí!
            </h3>
        ...
        <div class="space-y-4">
          ...
          <div class="bg-white rounded-[20px] overflow-hidden border border-gray-100 shadow-[0_2px_12px_-4px_rgba(0,0,0,0.06)] flex p-2.5 gap-4 items-center">
            ...
            <div class="flex-1 flex flex-col justify-center pr-2 py-1">
              <div class="inline-block bg-[#388e3c] text-white text-[11px] font-bold px-2 py-0.5 rounded mb-1.5 self-start">
                Sorteo
              </div>
      ...
      <div class="animate-in fade-in duration-300">
        ...
        <div class="bg-white rounded-[24px] border border-gray-100 shadow-[0_2px_16px_-4px_rgba(0,0,0,0.08)] p-6 mb-8 relative">
          ...
          <div class="flex items-center gap-5 mb-8 pr-6 mt-1">
            <!-- Hexagon Badge PNG en contenedor delimitador con estilos inline seguros -->
            ...
            <div class="pt-1">
              ...
              <p class="text-[15px] text-gray-600 leading-snug">
                Completa los pagos necesarios y sube tu nivel. Se actualizará a inicios del próximo mes.
              </p>
            </div>
          </div>
          ...
          <!-- Barra de progreso -->
          <div class="mt-4">
            <p class="text-[14px] text-gray-600 font-medium mb-2">
              Este mes completaste <span class="text-[#4a148c] font-bold">0 pagos</span>
            </p>
